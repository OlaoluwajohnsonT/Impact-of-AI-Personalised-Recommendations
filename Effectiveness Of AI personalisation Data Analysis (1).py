...
# Adjusting the gender column to male and female 
df['What is your gender?'] = df['What is your gender?'].replace({
    'Man': 'Male',  # Replace all "Man" entries with "Male"
    'Woman': 'Female',  # Replace all "Woman" entries with "Female"
    # Add any other necessary mappings here if needed
})
...
axes[0, 0].set_title('(A) Age Group Distribution')
...
axes[0, 1].set_title('(B) Gender Distribution')

# (C) Monthly Income Range Distribution - Bar chart
sns.countplot(data=df, x='What is your monthly income range?', ax=axes[1, 0], palette='mako')
axes[1, 0].set_title('(C) Monthly Income Range Distribution')
axes[1, 0].set_xlabel('Monthly Income Range (Naira)')
axes[1, 0].set_ylabel('Number of Respondents')
axes[1, 0].set_xticklabels(axes[1, 0].get_xticklabels(), rotation=45, ha='right')

# (D) Shopping Frequency on Jumia - Bar chart
sns.countplot(data=df, x='How frequently do you shop on Jumia?', ax=axes[1, 1], palette='crest')
axes[1, 1].set_title('(D) Shopping Frequency on Jumia')
...
# (A) Satisfaction with Personalized Recommendations
sns.countplot(data=df, y='How satisfied are you with the personalised recommendations provided by Jumia?', ax=axes[0, 0], palette='YlOrRd')
axes[0, 0].set_title('(A) Satisfaction with Personalised Recommendations')
axes[0, 0].set_ylabel('Satisfaction Level')
axes[0, 0].set_xlabel('Number of Respondents')

# (B) Alignment of AI Recommendations with Customer Preferences
sns.countplot(data=df, y="How well do you think Jumia's personalised recommendations reflect your personal preferences and lifestyle?", ax=axes[0, 1], palette='coolwarm')
axes[0, 1].set_title("(B) Alignment of AI Recommendations with Customer Preferences")
axes[0, 1].set_ylabel('Reflection of Preferences and Lifestyle')
axes[0, 1].set_xlabel('Number of Respondents')

# (C) Comfort Level with Data Usage in AI Recommendations
sns.countplot(data=df, y="Are you comfortable with Jumia using your browsing and purchasing data to provide personalised recommendations?", ax=axes[1, 0], palette='OrRd')
axes[1, 0].set_title("(C) Comfort Level with Data Usage in AI Recommendations")
axes[1, 0].set_ylabel('Comfort Level')
axes[1, 0].set_xlabel('Number of Respondents')

# (D) Interaction Frequency with AI Recommendations
sns.countplot(data=df, y="How often do you interact with Jumia’s AI-personalised product recommendations (e.g., clicking on recommended items, adding items to cart)?", ax=axes[1, 1], palette='coolwarm')
axes[1, 1].set_title("(D) Interaction Frequency with AI Recommendations")
axes[1, 1].set_ylabel('Interaction Frequency')
...
# (A) Customer Loyalty Influenced by AI Personalisation
...
axes[0, 0].set_title("(A) Customer Loyalty Influenced by AI Personalisation")
axes[0, 0].set_ylabel('Loyalty Level')
axes[0, 0].set_xlabel('Number of Respondents')

# (B) Reflection of Actual Preferences and Needs
...
axes[0, 1].set_title("(B) Reflection of Actual Preferences and Needs in AI Recommendations")
axes[0, 1].set_ylabel('Reflection Level')
axes[0, 1].set_xlabel('Number of Respondents')

# (C) Cultural Relevance of AI Recommendations
...
axes[1, 0].set_title("(C) Cultural Relevance of AI Recommendations")
axes[1, 0].set_ylabel('Cultural Relevance Level')
axes[1, 0].set_xlabel('Number of Respondents')

# (D) Economic Relevance of AI Recommendations
...
axes[1, 1].set_title("(D) Economic Relevance of AI Recommendations")
axes[1, 1].set_ylabel('Economic Relevance Level')
axes[1, 1].set_xlabel('Number of Respondents')
...
# (A) Privacy Concerns about AI Recommendations
...
axes[0, 0].set_title("(A) Privacy Concerns about AI Recommendations")
axes[0, 0].set_ylabel("Privacy Concern Level")
axes[0, 0].set_xlabel("Number of Respondents")

# (B) Trust Improvement with Data Transparency
...
axes[0, 1].set_title("(B) Trust Improvement with Data Transparency")
axes[0, 1].set_ylabel("Trust Level")
axes[0, 1].set_xlabel("Number of Respondents")

# (C) Influence of Purchasing Power on AI Recommendations Relevance
...
axes[1, 0].set_title("(C) Influence of Purchasing Power on AI Recommendations Relevance")
axes[1, 0].set_ylabel("Purchasing Power Influence Level")
axes[1, 0].set_xlabel("Number of Respondents")

# (D) Frequency of Challenges or Limitations with AI Recommendations
...
axes[1, 1].set_title("(D) Frequency of Challenges or Limitations with AI Recommendations")
...
# Setting up a 2x2 grid layout for transposed visualisations
fig, axes = plt.subplots(2, 2, figsize=(16, 12))

# Plot (A): Frequency of noticing product recommendations based on previous shopping habits
sns.countplot(data=df, y="How often do you notice that the product recommendations on Jumia are based on your previous shopping habits?", palette="Blues", ax=axes[0, 0])
axes[0, 0].set_title("(A) Frequency of Noticing Recommendations Based on Previous Shopping Habits")
axes[0, 0].set_xlabel("Number of Respondents")
axes[0, 0].set_ylabel("Frequency of Observing Recommendations")

# Plot (B): Frequency of purchasing items based on personalised recommendations
sns.countplot(data=df, y="How often do you purchase items based on Jumia’s personalised recommendations?", palette="Oranges", ax=axes[0, 1])
axes[0, 1].set_title("(B) Frequency of Purchasing Items Based on Personalised Recommendations")
axes[0, 1].set_xlabel("Number of Respondents")
axes[0, 1].set_ylabel("Frequency of Purchasing Based on Recommendations")

# Plot (C): Impact of challenges on overall interaction with the platform
sns.countplot(data=df, y="How have the challenges you’ve experienced with Jumia’s AI-personalised recommendations (e.g., irrelevant recommendations, privacy concerns) affected your overall interaction with the platform?", palette="Greens", ax=axes[1, 0])
axes[1, 0].set_title("(C) Impact of Challenges on Interaction with the Platform")
axes[1, 0].set_xlabel("Number of Respondents")
axes[1, 0].set_ylabel("Impact on Interaction")

# Plot (D): Influence of personalised recommendations on repeat purchases
sns.countplot(data=df, y="Have Jumia’s personalised recommendations influenced your decision to make repeat purchases on the platform?", palette="Purples", ax=axes[1, 1])
axes[1, 1].set_title("(D) Influence of Recommendations on Repeat Purchases")
axes[1, 1].set_xlabel("Number of Respondents")
axes[1, 1].set_ylabel("Response to Influence on Repeat Purchases")
...
# Selecting additional numeric columns for correlation analysis
correlation_matrix = df[['Satisfaction_Level', 'Trust_Level', 
                         'Loyalty_Level', 'Preference_Level', 
                         'Economic_Relevance', 'Privacy_Concern_Level', 
                         'Digital_Literacy', 'Shopping_Frequency_Level']].corr()
...
plt.title("Correlation Matrix of Satisfaction, Trust, Engagement, and Related Factors", fontsize=16, fontweight='bold')
...
# Set up 2x2 grid layout for transposed visualisation
fig, axes = plt.subplots(2, 2, figsize=(14, 12))

# (A) Privacy Concerns by Engagement Level
sns.boxplot(data=df, y="Are you concerned about the privacy of your personal data used for Jumia's personalised recommendations?", 
            x='Engagement_Level', palette='cool', ax=axes[0, 0])
axes[0, 0].set_title("(A) Privacy Concerns by Engagement Level")
axes[0, 0].set_ylabel("Level of Privacy Concern (Low to High)")
axes[0, 0].set_xlabel("Customer Engagement Level (1-5)")

# (B) Effect of Transparency on Trust and Satisfaction
sns.boxplot(data=df, y="Would clearer information on how your data is used improve your trust in Jumia's AI system?", 
            x='Satisfaction_Level', palette='magma', ax=axes[0, 1])
axes[0, 1].set_title("(B) Effect of Transparency on Trust and Satisfaction")
axes[0, 1].set_ylabel("Level of Transparency Improvement")
axes[0, 1].set_xlabel("Customer Satisfaction Level (1-5)")

# (C) Satisfaction Level by Income Range
sns.boxplot(data=df, y='What is your monthly income range?', x='Satisfaction_Level', palette='coolwarm', ax=axes[1, 0])
axes[1, 0].set_title('(C) Satisfaction Level by Income Range')
axes[1, 0].set_ylabel('Monthly Income Range (in NGN)')
axes[1, 0].set_xlabel('Customer Satisfaction Level (1-5)')

# (D) Trust by Satisfaction Level with AI Recommendations
sns.boxplot(data=df, y="Would clearer information on how your data is used improve your trust in Jumia's AI system?", 
            x="Satisfaction_Level", palette="viridis", ax=axes[1, 1])
axes[1, 1].set_title("(D) Trust by Satisfaction Level with AI Recommendations")
axes[1, 1].set_ylabel("Level of Transparency Improvement")
axes[1, 1].set_xlabel("Customer Satisfaction Level (1-5)")
...
# (A) Impact of Income on Satisfaction with AI Recommendations
sns.boxplot(data=df, x='What is your monthly income range?', y='Satisfaction_Level', palette='coolwarm', ax=axes[0, 0])
axes[0, 0].set_title('(A) Impact of Income on Satisfaction with AI Recommendations')
axes[0, 0].set_xlabel('Monthly Income Range (NGN)')
axes[0, 0].set_ylabel('Satisfaction Level (1-5)')
axes[0, 0].tick_params(axis='x', rotation=45)

# (B) Effect of Transparency on Trust and Satisfaction
sns.boxplot(data=df, x="Would clearer information on how your data is used improve your trust in Jumia's AI system?", 
            y='Satisfaction_Level', palette='magma', ax=axes[0, 1])
axes[0, 1].set_title('(B) Effect of Transparency on Trust and Satisfaction')
axes[0, 1].set_xlabel('Level of Trust Improvement (1-5)')
axes[0, 1].set_ylabel('Satisfaction Level (1-5)')
axes[0, 1].tick_params(axis='x', rotation=45)

# (C) Satisfaction Level by Income Range (Count Plot)
sns.countplot(data=df, y='What is your monthly income range?', hue='How satisfied are you with the personalised recommendations provided by Jumia?', 
              palette='magma', ax=axes[1, 0])
axes[1, 0].set_title('(C) Satisfaction Level by Income Range')
axes[1, 0].set_xlabel('Number of Respondents')
axes[1, 0].set_ylabel('Monthly Income Range (NGN)')
axes[1, 0].legend(title='Satisfaction Level', bbox_to_anchor=(1.05, 1), loc='upper left')

# (D) Engagement Frequency by Age Group
sns.countplot(data=df, x='What is your age group?', hue='How frequently do you shop on Jumia?', palette='coolwarm', ax=axes[1, 1])
axes[1, 1].set_title('(D) Engagement Frequency by Age Group')
axes[1, 1].set_xlabel('Age Group')
axes[1, 1].set_ylabel('Number of Respondents')
axes[1, 1].tick_params(axis='x', rotation=45)
axes[1, 1].legend(title='Shopping Frequency', bbox_to_anchor=(1.05, 1), loc='upper left')

# (E) Cultural Relevance of AI Recommendations by Age Group
sns.countplot(data=df, x='What is your age group?', hue="To what extent do you feel that Jumia's personalised recommendations reflect the cultural realities of living in Lagos?", 
              palette='viridis', ax=axes[2, 0])
axes[2, 0].set_title('(E) Cultural Relevance of AI Recommendations by Age Group')
...
# (F) Satisfaction Level vs. Loyalty Level (Coloured by Trust Level)
sns.scatterplot(data=df, x='Satisfaction_Level', y='Loyalty_Level', hue='Trust_Level', palette="viridis", s=100, alpha=0.7, ax=axes[2, 1])
axes[2, 1].set_title('(F) Satisfaction Level vs. Loyalty Level (Coloured by Trust Level)')
axes[2, 1].set_xlabel('Satisfaction Level (1-5)')
axes[2, 1].set_ylabel('Loyalty Level (1-5)')
...
axes[0].set_title("A: Average Weighted Scale for Relevance of Personalised Recommendations")
...
axes[1].set_title("B: Average Weighted Scale for Improvement in Shopping Experience")
...
# Step 1: Filter the data for people earning below ₦50,000
below_50000_df = df[df['What is your monthly income range?'] == 'Below ₦50,000']

# Step 2: Concatenate all relevant text responses for each column
# Replace these column names with the actual qualitative column names
col1_text = below_50000_df['What challenges or limitations have you experienced with Jumia\'s AI-personalised recommendation system? (Select all that apply)'].dropna().str.cat(sep=' ')
col2_text = below_50000_df['How do you think Jumia’s AI-personalised recommendations could better cater to your needs, considering factors such as your purchasing habits, product preferences, income level, and browsing behaviour'].dropna().str.cat(sep=' ')
col3_text = below_50000_df['Please provide any additional comments you have about Jumia’s AI-personalised recommendation system.'].dropna().str.cat(sep=' ')

# Step 3: Generate Word Clouds
wordcloud1 = WordCloud(width=800, height=400, background_color='white', colormap='viridis', max_words=200).generate(col1_text)
wordcloud2 = WordCloud(width=800, height=400, background_color='white', colormap='plasma', max_words=200).generate(col2_text)
wordcloud3 = WordCloud(width=800, height=400, background_color='white', colormap='inferno', max_words=200).generate(col3_text)

# Step 4: Display Word Clouds in a Single Visual with a Heading
fig, axes = plt.subplots(3, 1, figsize=(12, 20))

# Add a main title to the figure
fig.suptitle("Word Cloud Analysis for Respondents Earning Below ₦50,000", fontsize=18, fontweight='bold')

# Plot for column 1
axes[0].imshow(wordcloud1, interpolation='bilinear')
axes[0].axis('off')
axes[0].set_title("(A) Challenges or Limitations Experienced with Jumia’s AI Recommendations", fontsize=16, fontweight='bold')

# Plot for column 2
axes[1].imshow(wordcloud2, interpolation='bilinear')
axes[1].axis('off')
axes[1].set_title("(B) Suggestions for Catering Better to User Needs", fontsize=16, fontweight='bold')

# Plot for column 3
axes[2].imshow(wordcloud3, interpolation='bilinear')
axes[2].axis('off')
axes[2].set_title("(C) Additional Comments on Jumia’s AI-Personalised Recommendation System", fontsize=16, fontweight='bold')
...
# Plot (A): General suggestions
axes[0].imshow(wordcloud1, interpolation='bilinear')
axes[0].axis('off')
axes[0].set_title("(A) Suggested Improvements for Jumia’s AI-Personalised Recommendations", fontsize=20, fontweight='bold')

# Plot (B): Privacy concerns
axes[1].imshow(wordcloud2, interpolation='bilinear')
axes[1].axis('off')
axes[1].set_title("(B) Concerns Regarding Use of Personal Data for AI Recommendations", fontsize=20, fontweight='bold')

# Plot (C): Additional comments
axes[2].imshow(wordcloud3, interpolation='bilinear')
axes[2].axis('off')
axes[2].set_title("(C) Additional Comments on Jumia’s AI-Personalised Recommendation System", fontsize=20, fontweight='bold')
...
# Load your dataset (assuming you have it in a DataFrame called df)
# df = pd.read_csv('your_data.csv')  # Load your data if not already loaded

# Specify the columns you are interested in
key_columns = [
    'Cultural_Relevance', 'Economic_Relevance', 'Digital_Literacy', 
    'Shopping_Frequency_Level', 'Infrastructure_Limitation', 
    'Effectiveness_Perception'
]

# Get descriptive statistics for these columns
descriptive_stats_key_columns = df[key_columns].describe()

# Display the results
print(descriptive_stats_key_columns)
